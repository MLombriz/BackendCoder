...
const administrador = constant.administrator
...
exports.listarProdById = (req, res) => {
...
exports.actualizarProd = (req, res) => {
    if (administrador) {
        let producto = productos.find(producto => producto.id === Number(req.params.id));
